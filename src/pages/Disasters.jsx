  ...
  return (
    <div>
      {loading ? (
        ...
        <div>
          <h2 className="text-3xl font-semibold mb-4 text-purple-700">Disaster Events</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {disasters.map((disaster) => (
              <div key={disaster._id} className="bg-white shadow-md p-4 rounded-lg">
                <h3 className="text-xl font-semibold text-blue-800">
                  {disaster.typeOfDisaster}
                </h3>
                <p className="text-sm text-gray-500 mt-2">{disaster.timestamp}</p>
